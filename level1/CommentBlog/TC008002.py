...
class TC008002(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008002(self):
        ...
        driver.find_element_by_id("input-comment").send_keys("hihihihihihihiihiihiihiii")
        ...
        try: self.assertEqual("hihihihihihihiihiihiihiii", driver.find_element_by_xpath("//li[@id='comment3947']/div/p").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
