...
class TC008010(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008010(self):
        ...
        try: self.assertEqual("Comment cannot be empty.", driver.find_element_by_xpath("//form[@id='form-comment']/div").text)
