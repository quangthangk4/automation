...
class TC008011(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008011(self):
        ...
        driver.find_element_by_id("input-comment").send_keys("###$$$%%%***!###$$$%%%***!###$$$%%%***!@")
        ...
        try: self.assertRegexpMatches(driver.find_element_by_xpath("//li[@id='comment3968']/div/p").text, r"^###\$\$\$%%%[\s\S]*[\s\S]*[\s\S]*!###\$\$\$%%%[\s\S]*[\s\S]*[\s\S]*!###\$\$\$%%%[\s\S]*[\s\S]*[\s\S]*!@$")
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("comment3968").click()
