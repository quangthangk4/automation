...
class TC008012(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008012(self):
        ...
        driver.find_element_by_id("input-comment").send_keys("alert('this is a XSS, hihiihihihihihihihihiii')")
        ...
        driver.find_element_by_id("comment3968").click()
        try: self.assertEqual("alert('this is a XSS, hihiihihihihihihihihiii')", driver.find_element_by_xpath("//li[@id='comment3968']/div/p").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
        driver.find_element_by_id("comment3968").click()
        try: self.assertEqual("Loser Lord", driver.find_element_by_xpath("//li[@id='comment3968']/div/h6").text)
        except AssertionError as e: self.verificationErrors.append(str(e))
