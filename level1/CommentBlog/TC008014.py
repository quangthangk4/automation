...
class TC008014(unittest.TestCase):
    def setUp(self):
    ...
    def test_t_c008014(self):
        ...
        driver.find_element_by_id("input-name").click()
        driver.find_element_by_id("input-name").clear()
        driver.find_element_by_id("input-name").send_keys("Quang Thang")
        driver.find_element_by_id("input-comment").click()
        driver.find_element_by_id("input-comment").clear()
        driver.find_element_by_id("input-comment").send_keys("This is a test comment with more\nthan twenty five\nchars.")
        driver.find_element_by_id("button-comment").click()
        time.sleep(2)
        driver.find_element_by_xpath("//form[@id='form-comment']/div").click()
        try: self.assertEqual("Please login to comment", driver.find_element_by_xpath("//form[@id='form-comment']/div").text)
